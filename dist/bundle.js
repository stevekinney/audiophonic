...
/***/ function(module, exports, __webpack_require__) {
	...
	var _startNote$stopNote = __webpack_require__(1);

	var _bindComputerKeyboardEvents = __webpack_require__(2);

	var _bindComputerKeyboardEvents2 = _interopRequireDefault(_bindComputerKeyboardEvents);

	__webpack_require__(4);

	_$2['default'](document).ready(function () {
	  _$2['default']('.piano-key').hover(_startNote$stopNote.startNote, _startNote$stopNote.stopNote);
	  _bindComputerKeyboardEvents2['default']('.active-key');
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _synthesizer = __webpack_require__(6);
	...
	function startNote() {
	  var note = _$2['default'](this).data('piano-key');
	  var classAttr = _$2['default'](this).attr('class');
	  _$2['default'](this).attr('class', '' + classAttr + ' active');
	  if (note) {
	    _synthesizer2['default'](note).start();
	  }
	}
	...
	function stopNote() {
	  var note = _$2['default'](this).data('piano-key');
	  var classAttr = _$2['default'](this).attr('class');
	  _$2['default'](this).attr('class', classAttr.replace(/active/gi, ''));
	  if (note) {
	    _synthesizer2['default'](note).stop();
	  }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = function (selector) {
	  _$2['default'](selector).each(function (index, element) {
	    var keyCode = _$2['default'](element).data('key-code');
	    if (!computerKeys[keyCode]) {
	      computerKeys[keyCode] = [];
	    }
	    computerKeys[keyCode].push(element);
	  });

	  _$2['default'](document).keydown(function (event) {
	    var classAttr = _$2['default'](computerKeys[event.keyCode]).attr('class');
	    _$2['default'](computerKeys[event.keyCode]).attr('class', '' + classAttr + ' active');
	  ...
	  _$2['default'](document).keyup(function (event) {
	    var classAttr = _$2['default'](computerKeys[event.keyCode]).attr('class');
	    _$2['default'](computerKeys[event.keyCode]).attr('class', classAttr.replace(/active/gi, ''));
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = function (note) {
	  ...
	  if (!notes[frequency]) {
	    notes[frequency] = new Synthesizer(frequency, destination);
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _normalizeNote2 = __webpack_require__(18);
